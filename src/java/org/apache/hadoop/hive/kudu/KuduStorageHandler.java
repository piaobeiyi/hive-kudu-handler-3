...
public class KuduStorageHandler extends DefaultStorageHandler implements HiveStoragePredicateHandler, HiveStorageHandler {
    ...
    /**
     * addDependencyJars Utilities.addDependencyJars
    ...
    public static final String KUDU_MASTER_ADDRS_KEY_DEFAULT = "localhost:7051";
    ...
    public void configureJobConf(TableDesc tableDesc, JobConf jobConf) {
        ...
        try {
            KuduHiveUtils.addDependencyJars(jobConf, KuduStorageHandler.class);
        } catch (IOException e) {
    ...
    public URI getURIForAuth(Table table) throws URISyntaxException {
        Map<String, String> tableProperties = KuduHiveUtils.getTableProperties(table);
